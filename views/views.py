...
class CatalogsTableWrapperView(
    ModelPermissionMixin, LoginRequiredMixin, SingleTableMixin, FilterView
):
    permission_required = "questions.view_catalog"
    model = Catalog
    ...
    def get_context_data(self, **kwargs):
        ...
        context["catalogs_count"] = Catalog.objects.count()
        return context
...
class SitesListView(ModelPermissionMixin, LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context_extra = {
            ...
            "has_all_sites": Site.objects.count()
            == self.object_list.sites.values().count(),
